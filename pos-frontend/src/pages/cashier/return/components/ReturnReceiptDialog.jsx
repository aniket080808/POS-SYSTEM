              ...
              {selectedOrder?.items
                ...
                ?.map((item) => (
                  <TableRow key={item.id}>
                    ...
                    <TableCell className="text-right py-2">{formatCurrency(item.product?.sellingPrice)}</TableCell>
                    <TableCell className="text-right py-2">
                      {formatCurrency((item.product?.sellingPrice || 0) * (item.returnQuantity || 0))}
                    </TableCell>
                  </TableRow>
                ))}
            </TableBody>
