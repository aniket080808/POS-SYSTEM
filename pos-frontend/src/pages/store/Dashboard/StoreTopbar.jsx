...
export default function StoreTopbar() {
  ...
  return (
    <header className="w-full h-16 bg-card border-b flex items-center px-6 justify-between shadow-xs">
      {/* Search */}
      <div className="flex-1 max-w-md relative">
        <Input placeholder="Search store..." className="w-full h-9 text-sm" />
      </div>
