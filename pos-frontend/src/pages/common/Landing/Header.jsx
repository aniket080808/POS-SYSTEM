...
const Header = () => {
  ...
  return (
    <header className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${isScrolled ? 'bg-card/95 shadow-xs backdrop-blur-sm border-b' : 'bg-transparent'}`}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-20">
            {/* Logo */}
            <div className="flex items-center">
              <div className="flex items-center space-x-2.5 group cursor-pointer" onClick={() => navigate('/')}>
                <div className="w-10 h-10 bg-primary text-primary-foreground rounded-xl flex items-center justify-center shadow-xs group-hover:shadow-md transition-all duration-200">
            ...
            <nav className="hidden md:flex items-center space-x-6">
              ...
              <a href="#pricing" className="text-sm font-medium text-muted-foreground hover:text-foreground transition-colors py-2">Pricing</a>
              <a href="#contact" className="text-sm font-medium text-muted-foreground hover:text-foreground transition-colors py-2">Contact</a>
            </nav>

            {/* CTA Button */}
            <div className="hidden md:flex items-center space-x-3">
              <Button onClick={handleLoginButtonClick} variant="outline" className="font-medium text-sm">Sign In</Button>
              <Button onClick={() => navigate('/auth/onboarding')} className="font-medium text-sm bg-accent text-accent-foreground hover:bg-accent/90">Get Started</Button>
            </div>
            ...
            <div className="md:hidden flex items-center space-x-2">
              <button
                ...
                className="text-muted-foreground hover:text-foreground p-2 rounded-md focus:outline-none"
              >
