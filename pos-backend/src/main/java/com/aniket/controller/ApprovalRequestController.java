...
public class ApprovalRequestController {
    ...
    public ResponseEntity<ApiResponse<ApprovalRequestDTO>> approveRequest(
        ...
        return ResponseEntity.ok(new ApiResponse<>(true, "Approval request approved successfully.", ApprovalRequestMapper.toDto(request)));
    }
    ...
    public ResponseEntity<ApiResponse<ApprovalRequestDTO>> rejectRequest(
        ...
        return ResponseEntity.ok(new ApiResponse<>(true, "Approval request rejected.", ApprovalRequestMapper.toDto(request)));
    }
