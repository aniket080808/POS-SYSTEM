...
const Upgrade = () => {
  ...
  }, [dispatch, searchParams, userProfile?.id]);
  ...
  if (userProfile && userProfile.role !== 'ROLE_STORE_ADMIN') {
    return (
      <div className="max-w-2xl mx-auto py-16 px-4 text-center">
        <div className="p-8 bg-amber-50/50 border border-amber-200 rounded-2xl shadow-sm space-y-4">
          <div className="p-4 bg-amber-100 rounded-full text-amber-600 w-fit mx-auto">
