      ...
      <DialogPrimitive.Content
        ...
        {showCloseButton && (
          <DialogPrimitive.Close
            ...
            className="focus:ring-ring absolute top-4 right-4 rounded-lg p-1.5 text-muted-foreground opacity-70 transition-opacity hover:opacity-100 hover:bg-secondary focus:ring-2 focus:outline-hidden disabled:pointer-events-none cursor-pointer">
            <X className="w-4 h-4" />
...
function DialogHeader({
  ...
  return (
    <div
      ...
      className={cn("flex flex-col gap-1.5 text-left pb-2 border-b border-border/60", className)}
      {...props} />
  );
}
